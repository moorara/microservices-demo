...
import (
	...
	"github.com/moorara/microservices-demo/services/switch/internal/service"
	"github.com/stretchr/testify/assert"

	arango "github.com/arangodb/go-driver"
	arangoUtil "github.com/moorara/microservices-demo/services/switch/pkg/arango"
)
...
func TestArangoHTTPService(t *testing.T) {
	...
	arangoHTTPService := arangoUtil.NewHTTPService(address)
	...
	t.Run("Login", func(t *testing.T) {
		...
		err := arangoHTTPService.Login(ctx, user, password)
		assert.NoError(t, err)
	})
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			t.Run("CreateArangoService", func(t *testing.T) {
				arangoService, err = service.NewArangoService([]string{address}, user, password)
				assert.NoError(t, err)
